...
- **[google-cloud](./google-cloud/SKILL.md)** - Inspect Google Cloud BigQuery and Cloud Logging through local `gcloud` and `bq` credentials.
- **[google-office](./google-office/SKILL.md)** - Use the `goog` CLI for Google Drive, Docs, Sheets, and GoogleMail via local OAuth.
